...
import org.marker.protocol.sgip.msg.*;
...
//	监听端口：9091
    ...
    public static void testMT() throws Exception {
        ...
        Bind bind = new Bind(loginType, loginName, passWord);
        ...
        //本地用户帐号密码（网关访问本地参数）
        session.setLocalUser(loginName);
        session.setLocalPass(passWord);
        ...
        try {
            MessageContent = "hello, 你好".getBytes("GBK");
